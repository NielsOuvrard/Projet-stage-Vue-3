<script setup lang="ts">
    ...
    const creditInfo = ref<CreditsFromMovie[] | null>()

    onMounted(async () => {
        creditInfo.value = await API.allActorsFromMovieRequest(
...
<template>
    <div class="actorsMenu">
        <div class="table">
            <div class="table__row">
                <div
                    v-for="actor in creditInfo"
                    :key="actor.id"
...
<style lang="scss" scoped>
    ...
    .imagesActor {
        border-radius: 0.4em;
        height: 10em;
        box-shadow: 0.2em 0.2em 0.4em rgb(0, 0, 0);
    }
